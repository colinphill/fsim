...
set(FSIM_INITIAL_STAGE "${FSIM_WORK_DIR}/staged-origin")
set(FSIM_STAGE "${FSIM_WORK_DIR}/relocated install é")
...
set(FSIM_EXPECTED_PATHS
  ...
  "${FSIM_STAGE}/${FSIM_API_LIBRARY_DIR}/${FSIM_TF_LIBRARY_NAME}"
  ...
  "${FSIM_STAGE}/${FSIM_LIBDIR}/cmake/fsim/fsimConfig.cmake"
  "${FSIM_STAGE}/${FSIM_LIBDIR}/cmake/fsim/fsimConfigVersion.cmake"
...
foreach(FSIM_TF_HEADER IN ITEMS
  ...
  file(SHA256
    ...
    FSIM_SOURCE_DIGEST)
  file(SHA256
    "${FSIM_STAGE}/${FSIM_INCLUDEDIR}/fsim/runtime/${FSIM_TF_HEADER}"
    FSIM_INSTALLED_DIGEST)
  if(NOT FSIM_SOURCE_DIGEST STREQUAL FSIM_INSTALLED_DIGEST)
    message(FATAL_ERROR
...
set(FSIM_API_CONSUMER_BUILD "${FSIM_WORK_DIR}/core-api-consumer-build")
set(FSIM_API_CONSUMER_CONFIGURE_COMMAND
  "${CMAKE_COMMAND}"
  -S "${FSIM_SOURCE_DIR}/tests/api/installed_consumer"
  -B "${FSIM_API_CONSUMER_BUILD}"
  -G "${FSIM_CMAKE_GENERATOR}"
  "-DCMAKE_PREFIX_PATH=${FSIM_STAGE}"
  "-DCMAKE_C_COMPILER=${FSIM_C_COMPILER}"
  "-DCMAKE_CXX_COMPILER=${FSIM_CXX_COMPILER}"
)
if(DEFINED FSIM_C_FLAGS AND NOT FSIM_C_FLAGS STREQUAL "")
  list(APPEND FSIM_API_CONSUMER_CONFIGURE_COMMAND
    "-DCMAKE_C_FLAGS=${FSIM_C_FLAGS}")
endif()
if(DEFINED FSIM_CXX_FLAGS AND NOT FSIM_CXX_FLAGS STREQUAL "")
  list(APPEND FSIM_API_CONSUMER_CONFIGURE_COMMAND
    "-DCMAKE_CXX_FLAGS=${FSIM_CXX_FLAGS}")
...
execute_process(
  COMMAND ${FSIM_API_CONSUMER_CONFIGURE_COMMAND}
  RESULT_VARIABLE FSIM_API_CONSUMER_CONFIGURE_RESULT
  OUTPUT_VARIABLE FSIM_API_CONSUMER_CONFIGURE_OUTPUT
  ERROR_VARIABLE FSIM_API_CONSUMER_CONFIGURE_ERROR
)
if(NOT FSIM_API_CONSUMER_CONFIGURE_RESULT EQUAL 0)
  message(FATAL_ERROR
    "installed core API consumer configure failed with "
    "${FSIM_API_CONSUMER_CONFIGURE_RESULT}\n"
    "${FSIM_API_CONSUMER_CONFIGURE_OUTPUT}"
    "${FSIM_API_CONSUMER_CONFIGURE_ERROR}")
endif()
set(FSIM_API_CONSUMER_BUILD_COMMAND
  "${CMAKE_COMMAND}" --build "${FSIM_API_CONSUMER_BUILD}" --parallel 8)
if(DEFINED FSIM_CONFIG AND NOT FSIM_CONFIG STREQUAL "")
  list(APPEND FSIM_API_CONSUMER_BUILD_COMMAND --config "${FSIM_CONFIG}")
endif()
execute_process(
  COMMAND ${FSIM_API_CONSUMER_BUILD_COMMAND}
  RESULT_VARIABLE FSIM_API_CONSUMER_BUILD_RESULT
  OUTPUT_VARIABLE FSIM_API_CONSUMER_BUILD_OUTPUT
  ERROR_VARIABLE FSIM_API_CONSUMER_BUILD_ERROR
)
if(NOT FSIM_API_CONSUMER_BUILD_RESULT EQUAL 0)
  message(FATAL_ERROR
    "installed core API consumer build failed with "
    "${FSIM_API_CONSUMER_BUILD_RESULT}\n"
    "${FSIM_API_CONSUMER_BUILD_OUTPUT}${FSIM_API_CONSUMER_BUILD_ERROR}")
endif()
set(FSIM_API_CONSUMER_PATH_FILE
  "${FSIM_API_CONSUMER_BUILD}/consumer-path-${FSIM_CONFIG}.txt")
if(NOT EXISTS "${FSIM_API_CONSUMER_PATH_FILE}")
  message(FATAL_ERROR
    "installed core API consumer path is missing: "
    "${FSIM_API_CONSUMER_PATH_FILE}")
endif()
file(READ "${FSIM_API_CONSUMER_PATH_FILE}" FSIM_API_CONSUMER_EXECUTABLE)
execute_process(
  COMMAND "${FSIM_API_CONSUMER_EXECUTABLE}"
  RESULT_VARIABLE FSIM_API_CONSUMER_RESULT
  OUTPUT_VARIABLE FSIM_API_CONSUMER_OUTPUT
  ERROR_VARIABLE FSIM_API_CONSUMER_ERROR
)
if(NOT FSIM_API_CONSUMER_RESULT EQUAL 0)
  message(FATAL_ERROR
    "installed core API consumer failed with ${FSIM_API_CONSUMER_RESULT}\n"
    "${FSIM_API_CONSUMER_OUTPUT}${FSIM_API_CONSUMER_ERROR}")
endif()

set(FSIM_TF_CONSUMER_BUILD "${FSIM_WORK_DIR}/tf-consumer-build")
set(FSIM_TF_CONSUMER_CONFIGURE_COMMAND
  "${CMAKE_COMMAND}"
  -S "${FSIM_SOURCE_DIR}/tests/runtime/installed_tf_consumer"
  -B "${FSIM_TF_CONSUMER_BUILD}"
  -G "${FSIM_CMAKE_GENERATOR}"
  "-DCMAKE_PREFIX_PATH=${FSIM_STAGE}"
  "-DCMAKE_C_COMPILER=${FSIM_C_COMPILER}"
)
if(DEFINED FSIM_C_FLAGS AND NOT FSIM_C_FLAGS STREQUAL "")
  list(APPEND FSIM_TF_CONSUMER_CONFIGURE_COMMAND
    "-DCMAKE_C_FLAGS=${FSIM_C_FLAGS}")
endif()
if(DEFINED FSIM_EXE_LINKER_FLAGS AND NOT FSIM_EXE_LINKER_FLAGS STREQUAL "")
  list(APPEND FSIM_TF_CONSUMER_CONFIGURE_COMMAND
...
execute_process(
  COMMAND ${FSIM_TF_CONSUMER_CONFIGURE_COMMAND}
  RESULT_VARIABLE FSIM_TF_CONSUMER_CONFIGURE_RESULT
  OUTPUT_VARIABLE FSIM_TF_CONSUMER_CONFIGURE_OUTPUT
  ERROR_VARIABLE FSIM_TF_CONSUMER_CONFIGURE_ERROR
)
if(NOT FSIM_TF_CONSUMER_CONFIGURE_RESULT EQUAL 0)
  message(FATAL_ERROR
    "installed TF consumer configure failed with "
    "${FSIM_TF_CONSUMER_CONFIGURE_RESULT}\n"
    "${FSIM_TF_CONSUMER_CONFIGURE_OUTPUT}"
    "${FSIM_TF_CONSUMER_CONFIGURE_ERROR}")
endif()
set(FSIM_TF_CONSUMER_BUILD_COMMAND
  "${CMAKE_COMMAND}" --build "${FSIM_TF_CONSUMER_BUILD}" --parallel 8)
if(DEFINED FSIM_CONFIG AND NOT FSIM_CONFIG STREQUAL "")
  list(APPEND FSIM_TF_CONSUMER_BUILD_COMMAND --config "${FSIM_CONFIG}")
endif()
execute_process(
  COMMAND ${FSIM_TF_CONSUMER_BUILD_COMMAND}
  RESULT_VARIABLE FSIM_TF_CONSUMER_BUILD_RESULT
  OUTPUT_VARIABLE FSIM_TF_CONSUMER_BUILD_OUTPUT
  ERROR_VARIABLE FSIM_TF_CONSUMER_BUILD_ERROR
)
if(NOT FSIM_TF_CONSUMER_BUILD_RESULT EQUAL 0)
  message(FATAL_ERROR
    "installed TF consumer build failed with ${FSIM_TF_CONSUMER_BUILD_RESULT}\n"
    "${FSIM_TF_CONSUMER_BUILD_OUTPUT}${FSIM_TF_CONSUMER_BUILD_ERROR}")
endif()
set(FSIM_TF_CONSUMER_PATH_FILE
  "${FSIM_TF_CONSUMER_BUILD}/consumer-path-${FSIM_CONFIG}.txt")
if(NOT EXISTS "${FSIM_TF_CONSUMER_PATH_FILE}")
  message(FATAL_ERROR
    "installed TF consumer path is missing: ${FSIM_TF_CONSUMER_PATH_FILE}")
endif()
file(READ "${FSIM_TF_CONSUMER_PATH_FILE}" FSIM_TF_CONSUMER_EXECUTABLE)
execute_process(
  COMMAND "${FSIM_TF_CONSUMER_EXECUTABLE}"
  RESULT_VARIABLE FSIM_TF_CONSUMER_RESULT
  OUTPUT_VARIABLE FSIM_TF_CONSUMER_OUTPUT
  ERROR_VARIABLE FSIM_TF_CONSUMER_ERROR
)
if(NOT FSIM_TF_CONSUMER_RESULT EQUAL 0)
  message(FATAL_ERROR
    "installed TF consumer failed with ${FSIM_TF_CONSUMER_RESULT}\n"
    "${FSIM_TF_CONSUMER_OUTPUT}${FSIM_TF_CONSUMER_ERROR}")
endif()
...
string(STRIP "${FSIM_VERSION_OUTPUT}" FSIM_VERSION_OUTPUT_STRIPPED)
if(NOT FSIM_VERSION_RESULT EQUAL 0
    OR NOT FSIM_VERSION_OUTPUT_STRIPPED STREQUAL
      "fsim ${FSIM_PROJECT_VERSION} (C API 1)")
  message(FATAL_ERROR
...
message(STATUS
  "installed public contract passed after read-only relocation to ${FSIM_STAGE}")
