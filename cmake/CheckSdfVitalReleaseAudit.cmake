...
if(NOT FSIM_AUTHORED_COUNT EQUAL 1306)
  message(FATAL_ERROR
    "authored SDF VITAL inventory changed: expected 1306 files, found ${FSIM_AUTHORED_COUNT}")
endif()
...
message(STATUS
  "SDF VITAL release audit: 17 rows, 2516 diagnostics, 1100 bounded sources, ${FSIM_AUTHORED_COUNT} SPDX-owned files")
