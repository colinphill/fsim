...
foreach(FSIM_EXACT_OUTPUT IN ITEMS
    ...
    "diagnostic catalog covers 2546 production codes"
    "Checked 1172 authored sources against the 2500-line hard limit with a 2000-line refactor target"
    "resource portability contract: five four-worker build/test steps, 120-minute hosted jobs, eight-link pool, compact Debug objects, 128 MiB Windows stacks, bounded large-test and FST value/change/hierarchy storage, pinned Boost headers, and scoped/SystemC phase traces are present")
...
if(NOT FSIM_AUTHORED_COUNT EQUAL 1459)
  message(FATAL_ERROR
    "authored SDF VITAL inventory changed: expected 1459 files, found ${FSIM_AUTHORED_COUNT}")
endif()
...
message(STATUS
  "SDF VITAL release audit: 17 rows, 2546 diagnostics, 1172 bounded sources, ${FSIM_AUTHORED_COUNT} SPDX-owned files")
