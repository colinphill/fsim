...
if(FSIM_TEST_CONTROL_COUNT LESS FSIM_EXPECTED_TEST_CONTROL_COUNT)
  message(FATAL_ERROR
    "FST test/control inventory fell below the ${FSIM_EXPECTED_TEST_CONTROL_COUNT}-file baseline: found ${FSIM_TEST_CONTROL_COUNT}")
endif()
...
message(STATUS
  "FST release audit: 17 rows, 2746 diagnostics, 1510 bounded sources, ${FSIM_AUTHORED_COUNT} SPDX-owned files, ${FSIM_TEST_CONTROL_COUNT} test/control files")
