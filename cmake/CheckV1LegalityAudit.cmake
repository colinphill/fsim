...
if(NOT FSIM_SYSTEMVERILOG_COUNT EQUAL 822)
  message(FATAL_ERROR
    "expected 822 SystemVerilog rows, found ${FSIM_SYSTEMVERILOG_COUNT}")
endif()
if(NOT FSIM_VHDL_COUNT EQUAL 279
    OR NOT FSIM_TASK5_GUARDED_COUNT EQUAL 269
    OR NOT FSIM_TASK6_VHDL_COUNT EQUAL 10)
  message(FATAL_ERROR
    "expected 279 VHDL rows split 269/10 across Tasks 5/6, found "
