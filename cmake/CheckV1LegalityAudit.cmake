...
if(NOT FSIM_SYSTEMVERILOG_COUNT EQUAL 681)
  message(FATAL_ERROR
    "expected 681 SystemVerilog v1 rows, found ${FSIM_SYSTEMVERILOG_COUNT}")
endif()
if(NOT FSIM_VHDL_COUNT EQUAL 269
    OR NOT FSIM_TASK5_GUARDED_COUNT EQUAL 259
    OR NOT FSIM_TASK6_VHDL_COUNT EQUAL 10)
  message(FATAL_ERROR
    "expected 269 VHDL rows split 259/10 across Tasks 5/6, found "
