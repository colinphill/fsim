...
if(NOT FSIM_SYSTEMVERILOG_COUNT EQUAL 854)
  message(FATAL_ERROR
    "expected 854 SystemVerilog rows, found ${FSIM_SYSTEMVERILOG_COUNT}")
endif()
if(NOT FSIM_VHDL_COUNT EQUAL 281
    OR NOT FSIM_TASK5_GUARDED_COUNT EQUAL 271
    OR NOT FSIM_TASK6_VHDL_COUNT EQUAL 10)
  message(FATAL_ERROR
    "expected 281 VHDL rows split 271/10 across Tasks 5/6, found "
