...
endforeach()
if(NOT FSIM_PATCH_COUNT EQUAL 6)
  message(FATAL_ERROR "SCV supply-chain audit requires six governed patches")
endif()
...
message(STATUS
  ...
  "documents=${FSIM_DOCUMENT_COUNT}, sboms=2, patches=6, "
  "signature=unsigned-release")
