...
foreach(FSIM_INDEX RANGE 2 18)
  ...
  if(FSIM_CHANGE EQUAL 13)
    set(FSIM_EXPECTED_CLOSURE "B188A-C19")
  endif()
...
foreach(FSIM_CHANGE RANGE 2 18)
  ...
  foreach(FSIM_CLOSURE_LIST IN ITEMS FSIM_MODE_CLOSURES FSIM_PACKAGE_CLOSURES)
    set(FSIM_LIST_EXPECTED_CLOSURE "${FSIM_EXPECTED_CLOSURE}")
    if(FSIM_CHANGE EQUAL 13
       AND FSIM_CLOSURE_LIST STREQUAL "FSIM_MODE_CLOSURES")
      set(FSIM_LIST_EXPECTED_CLOSURE "B188A-C19")
    endif()
    set(FSIM_MATCH_COUNT 0)
    foreach(FSIM_CLOSURE IN LISTS ${FSIM_CLOSURE_LIST})
      if(FSIM_CLOSURE STREQUAL FSIM_LIST_EXPECTED_CLOSURE)
        math(EXPR FSIM_MATCH_COUNT "${FSIM_MATCH_COUNT} + 1")
      endif()
    endforeach()
    if(NOT FSIM_MATCH_COUNT EQUAL 1)
      message(FATAL_ERROR
        "${FSIM_CLOSURE_LIST} must assign ${FSIM_LIST_EXPECTED_CLOSURE} exactly once")
    endif()
  endforeach()
endforeach()
