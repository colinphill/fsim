...
if(NOT FSIM_ROW_COUNT EQUAL 17)
  message(FATAL_ERROR "project manifest contract requires SPDX, header and 15 rows")
endif()
...
fsim_require_project_manifest_tokens("${FSIM_HEADER}"
  "kSchemaVersion = 2"
  "Parses, validates, and resolves a schema-2 fsim.toml"
...
fsim_require_project_manifest_tokens("${FSIM_TEST}"
  ...
  "unsupported project manifest identity: found no schema; required schema 2"
  "unsupported project manifest identity: found schema 0; required schema 2"
  "unsupported project manifest identity: found schema 3; required schema 2"
...
message(STATUS
  "project manifest schema freeze passed: rows=15 schema=2 digest=${FSIM_CONTRACT_DIGEST}")
