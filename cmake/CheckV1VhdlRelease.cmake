...
set(FSIM_AUDIT "${FSIM_SOURCE_DIR}/docs/v1-vhdl-release-audit.md")
...
foreach(FSIM_INPUT IN ITEMS "${FSIM_MATRIX}" "${FSIM_AUDIT}" "${FSIM_TEST_CMAKE}")
  if(NOT EXISTS "${FSIM_INPUT}")
    message(FATAL_ERROR "VHDL release-audit input not found: ${FSIM_INPUT}")
  endif()
endforeach()
...
foreach(FSIM_LINE IN LISTS FSIM_MATRIX_LINES)
  ...
  if(FSIM_FIELD_COUNT LESS 9)
    message(FATAL_ERROR "malformed VHDL release row: ${FSIM_ID}")
  endif()
...
if(NOT FSIM_ROW_COUNT EQUAL 273
    OR NOT FSIM_VH_COUNT EQUAL 265
    OR NOT FSIM_V1_VH_COUNT EQUAL 8)
  message(FATAL_ERROR
    "expected 273 VHDL rows split 265/8, found "
...
if(FSIM_RUNTIME_OWNER_COUNT LESS 20)
  message(FATAL_ERROR
    "expected at least 20 distinct VHDL runtime owners, found "
    "${FSIM_RUNTIME_OWNER_COUNT}")
endif()

set(FSIM_REVIEW_IDS
  B130-T3-VHDL-SYNTAX
  B130-T3-VHDL-SEMANTICS
  B130-T3-VHDL-PACKAGES
  B130-T3-VHDL-EXECUTION
  B130-T3-VHDL-RELEASE
)
foreach(FSIM_REVIEW_ID IN LISTS FSIM_REVIEW_IDS)
  ...
  if(FSIM_REVIEW_INDEX EQUAL -1)
    message(FATAL_ERROR "VHDL audit omits review ${FSIM_REVIEW_ID}")
  endif()
endforeach()

string(FIND
  "${FSIM_TEST_CMAKE_CONTENTS}"
  "NAME fsim.v1-vhdl-release"
  FSIM_REGISTRATION_INDEX
)
if(FSIM_REGISTRATION_INDEX EQUAL -1)
  message(FATAL_ERROR "fsim.v1-vhdl-release is not registered")
endif()

message(STATUS
  "final VHDL audit covers ${FSIM_ROW_COUNT} rows with "
