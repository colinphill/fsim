...
set(FSIM_SYSTEMVERILOG_VPI_COVERAGE_APPLICATION_TEST
  "${FSIM_SOURCE_DIR}/tests/app/vpi_application_test.cpp")
...
set(FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_MODEL
  "${FSIM_SOURCE_DIR}/include/fsim/frontend/systemverilog_standard_package.hpp")
set(FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_IMPLEMENTATION
  "${FSIM_SOURCE_DIR}/src/frontend/systemverilog_standard_package.cpp")
set(FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_DESIGN
  "${FSIM_SOURCE_DIR}/include/fsim/frontend/design.hpp")
set(FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_CACHE
  "${FSIM_SOURCE_DIR}/src/app/application_standard_package.cpp")
set(FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_TEST
  "${FSIM_SOURCE_DIR}/tests/app/sv_conformance_application_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_ANNEX_MODEL
  "${FSIM_SOURCE_DIR}/src/frontend/verilog_parser_internal.hpp")
set(FSIM_SYSTEMVERILOG_2023_ANNEX_POLICY
  "${FSIM_SOURCE_DIR}/src/frontend/verilog_parser_annex.cpp")
set(FSIM_SYSTEMVERILOG_2023_ANNEX_KEYWORDS
  "${FSIM_SOURCE_DIR}/src/frontend/verilog_parser_standard_support.cpp")
set(FSIM_SYSTEMVERILOG_2023_ANNEX_COMPATIBILITY
  "${FSIM_SOURCE_DIR}/src/frontend/verilog_parser_core.cpp")
set(FSIM_SYSTEMVERILOG_2023_ANNEX_EXPRESSIONS
  "${FSIM_SOURCE_DIR}/src/frontend/verilog_parser_expressions.cpp")
set(FSIM_SYSTEMVERILOG_2023_ANNEX_ASSERTIONS
  "${FSIM_SOURCE_DIR}/src/frontend/verilog_parser_assertions.cpp")
set(FSIM_SYSTEMVERILOG_2023_ANNEX_HIERARCHY
...
set(FSIM_SYSTEMVERILOG_2023_ANNEX_APPLICATION_TEST
  "${FSIM_SOURCE_DIR}/tests/app/sv_conformance_application_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_PLI_DPI_BRIDGE
  "${FSIM_SOURCE_DIR}/include/fsim/runtime/svdpi_bridge.h")
set(FSIM_SYSTEMVERILOG_2023_PLI_DPI_RUNTIME
  "${FSIM_SOURCE_DIR}/src/runtime/svdpi.cpp")
set(FSIM_SYSTEMVERILOG_2023_PLI_FRONTEND_TEST
  "${FSIM_SOURCE_DIR}/tests/frontend/frontend_dpi_tests.cpp")
set(FSIM_SYSTEMVERILOG_2023_PLI_TF_APPLICATION_TEST
  "${FSIM_SOURCE_DIR}/tests/app/tf_plugin_application_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_PLI_TF_SCHEDULER_TEST
  "${FSIM_SOURCE_DIR}/tests/app/tf_scheduler_application_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_PLI_ACC_TF_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/acc_tf_coherence_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_PLI_ACC_VPI_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/acc_vpi_coherence_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_COVERAGE_RUNTIME
  "${FSIM_SOURCE_DIR}/src/app/application_simulation_impl_setup.cpp")
set(FSIM_SYSTEMVERILOG_2023_CODE_COVERAGE_TEST
  "${FSIM_SOURCE_DIR}/tests/app/code_coverage_equivalence_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_FUNCTIONAL_COVERAGE_TEST
  "${FSIM_SOURCE_DIR}/tests/app/coverage_application_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_ASSERTION_COVERAGE_TEST
  "${FSIM_SOURCE_DIR}/tests/app/assertion_application_checker.cpp")
set(FSIM_SYSTEMVERILOG_2023_CALLBACK_MODEL
  "${FSIM_SOURCE_DIR}/include/fsim/runtime/vpi_callback.hpp")
set(FSIM_SYSTEMVERILOG_2023_CALLBACK_RUNTIME
  "${FSIM_SOURCE_DIR}/src/runtime/vpi_callback.cpp")
set(FSIM_SYSTEMVERILOG_2023_CALLBACK_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/runtime_vpi_callback_tests.cpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_MODEL
  "${FSIM_SOURCE_DIR}/include/fsim/runtime/vpi_object.hpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_RUNTIME
  "${FSIM_SOURCE_DIR}/src/runtime/vpi_object.cpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/runtime_vpi_object_tests.cpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_MODEL
  "${FSIM_SOURCE_DIR}/include/fsim/runtime/vpi_system.hpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_RUNTIME
  "${FSIM_SOURCE_DIR}/src/runtime/vpi_system.cpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/runtime_vpi_tests.cpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_HEADER
  "${FSIM_SOURCE_DIR}/include/vpi_user.h")
set(FSIM_SYSTEMVERILOG_2023_SV_VPI_STANDARD_HEADER
  "${FSIM_SOURCE_DIR}/include/sv_vpi_user.h")
set(FSIM_SYSTEMVERILOG_2023_VPI_BRIDGE
  "${FSIM_SOURCE_DIR}/include/fsim/runtime/vpi_bridge.h")
set(FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_RUNTIME
  "${FSIM_SOURCE_DIR}/src/runtime/vpi_standard.cpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_PLUGIN_RUNTIME
  "${FSIM_SOURCE_DIR}/src/runtime/vpi_plugin.cpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/runtime_vpi_reference_plugin_tests.cpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_C_PLUGIN
  "${FSIM_SOURCE_DIR}/tests/runtime/vpi_reference_plugin_c.c")
set(FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_CPP_PLUGIN
  "${FSIM_SOURCE_DIR}/tests/runtime/vpi_reference_plugin_cpp.cpp")
set(FSIM_SYSTEMVERILOG_2023_RUNTIME_TEST_MAIN
  "${FSIM_SOURCE_DIR}/tests/runtime/runtime_tests.cpp")
set(FSIM_SYSTEMVERILOG_2023_VPI_ABI_C_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/runtime_vpi_abi_c_test.c")
set(FSIM_SYSTEMVERILOG_2023_VPI_ABI_CPP_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/runtime_foreign_abi_cpp_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_DATA_READ_MODEL
  "${FSIM_SOURCE_DIR}/include/fsim/runtime/vpi_data_read.hpp")
set(FSIM_SYSTEMVERILOG_2023_DATA_READ_RUNTIME
  "${FSIM_SOURCE_DIR}/src/runtime/vpi_data_read.cpp")
set(FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION
  "${FSIM_SOURCE_DIR}/src/app/application_simulation_impl_setup.cpp")
set(FSIM_SYSTEMVERILOG_2023_DATA_READ_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/vpi_data_read_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION_TEST
  "${FSIM_SOURCE_DIR}/tests/app/vpi_application_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_ASSERTION_API_MODEL
  "${FSIM_SOURCE_DIR}/include/fsim/runtime/vpi_control.hpp")
set(FSIM_SYSTEMVERILOG_2023_ASSERTION_API_RUNTIME
  "${FSIM_SOURCE_DIR}/src/runtime/vpi_control.cpp")
set(FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION
  "${FSIM_SOURCE_DIR}/src/app/application_simulation_impl_setup.cpp")
set(FSIM_SYSTEMVERILOG_2023_ASSERTION_API_PUBLICATION
  "${FSIM_SOURCE_DIR}/src/app/application_simulation_impl_core.cpp")
set(FSIM_SYSTEMVERILOG_2023_ASSERTION_API_TEST
  "${FSIM_SOURCE_DIR}/tests/runtime/runtime_vpi_control_tests.cpp")
set(FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION_TEST
  "${FSIM_SOURCE_DIR}/tests/app/vpi_application_test.cpp")
...
set(FSIM_SYSTEMVERILOG_2023_RANDOM_HIR_TEST
  "${FSIM_SOURCE_DIR}/tests/app/systemverilog_hir_application_test.cpp")
set(FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_MODEL
  "${FSIM_SOURCE_DIR}/include/fsim/runtime/simir_operations_extended.hpp")
set(FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_RUNTIME
  "${FSIM_SOURCE_DIR}/src/runtime/simir_random_distribution.cpp")
set(FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_EXECUTION
  "${FSIM_SOURCE_DIR}/src/runtime/simir_execution_interpreter.cpp")
...
foreach(FSIM_INPUT IN ITEMS
    ...
    "${FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_MODEL}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_RUNTIME}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_TEST}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_MODEL}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_RUNTIME}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_TEST}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_HEADER}"
    "${FSIM_SYSTEMVERILOG_2023_SV_VPI_STANDARD_HEADER}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_BRIDGE}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_RUNTIME}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_PLUGIN_RUNTIME}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_TEST}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_C_PLUGIN}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_CPP_PLUGIN}"
    "${FSIM_SYSTEMVERILOG_2023_RUNTIME_TEST_MAIN}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_ABI_C_TEST}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_ABI_CPP_TEST}"
    "${FSIM_SYSTEMVERILOG_2023_DATA_READ_MODEL}"
    "${FSIM_SYSTEMVERILOG_2023_DATA_READ_RUNTIME}"
    "${FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION}"
    "${FSIM_SYSTEMVERILOG_2023_DATA_READ_TEST}"
    "${FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION_TEST}"
    "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_MODEL}"
    "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_RUNTIME}"
    "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION}"
    "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_PUBLICATION}"
    "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_TEST}"
    "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION_TEST}"
    ...
    "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_MODEL}"
    "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_RUNTIME}"
    "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_EXECUTION}"
    "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_BOUNDARY}"
    "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_CACHE}"
    "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_CACHE_TEST}"
    "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_ARTIFACT}"
    "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_ARTIFACT_TEST}"
...
file(READ "${FSIM_DIAGNOSTICS}" FSIM_DIAGNOSTICS_CONTENTS)
...
file(READ "${FSIM_SYSTEMVERILOG_VPI_COVERAGE_APPLICATION_TEST}"
  FSIM_SYSTEMVERILOG_VPI_COVERAGE_APPLICATION_TEST_CONTENTS)
...
file(READ "${FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_MODEL}"
  FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_MODEL_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_IMPLEMENTATION}"
  FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_IMPLEMENTATION_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_DESIGN}"
  FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_DESIGN_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_CACHE}"
  FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_CACHE_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_TEST}"
  FSIM_SYSTEMVERILOG_2023_STANDARD_PACKAGE_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ANNEX_MODEL}"
  FSIM_SYSTEMVERILOG_2023_ANNEX_MODEL_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ANNEX_POLICY}"
  FSIM_SYSTEMVERILOG_2023_ANNEX_POLICY_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ANNEX_KEYWORDS}"
  FSIM_SYSTEMVERILOG_2023_ANNEX_KEYWORDS_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ANNEX_COMPATIBILITY}"
  FSIM_SYSTEMVERILOG_2023_ANNEX_COMPATIBILITY_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ANNEX_EXPRESSIONS}"
  FSIM_SYSTEMVERILOG_2023_ANNEX_EXPRESSIONS_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ANNEX_ASSERTIONS}"
  FSIM_SYSTEMVERILOG_2023_ANNEX_ASSERTIONS_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ANNEX_HIERARCHY}"
...
file(READ "${FSIM_SYSTEMVERILOG_2023_ANNEX_APPLICATION_TEST}"
  FSIM_SYSTEMVERILOG_2023_ANNEX_APPLICATION_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_PLI_DPI_BRIDGE}"
  FSIM_SYSTEMVERILOG_2023_PLI_DPI_BRIDGE_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_PLI_DPI_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_PLI_DPI_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_PLI_FRONTEND_TEST}"
  FSIM_SYSTEMVERILOG_2023_PLI_FRONTEND_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_PLI_TF_APPLICATION_TEST}"
  FSIM_SYSTEMVERILOG_2023_PLI_TF_APPLICATION_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_PLI_TF_SCHEDULER_TEST}"
  FSIM_SYSTEMVERILOG_2023_PLI_TF_SCHEDULER_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_PLI_ACC_TF_TEST}"
  FSIM_SYSTEMVERILOG_2023_PLI_ACC_TF_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_PLI_ACC_VPI_TEST}"
  FSIM_SYSTEMVERILOG_2023_PLI_ACC_VPI_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_COVERAGE_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_COVERAGE_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_CODE_COVERAGE_TEST}"
  FSIM_SYSTEMVERILOG_2023_CODE_COVERAGE_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_FUNCTIONAL_COVERAGE_TEST}"
  FSIM_SYSTEMVERILOG_2023_FUNCTIONAL_COVERAGE_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ASSERTION_COVERAGE_TEST}"
  FSIM_SYSTEMVERILOG_2023_ASSERTION_COVERAGE_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_CALLBACK_MODEL}"
  FSIM_SYSTEMVERILOG_2023_CALLBACK_MODEL_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_CALLBACK_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_CALLBACK_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_CALLBACK_TEST}"
  FSIM_SYSTEMVERILOG_2023_CALLBACK_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_MODEL}"
  FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_MODEL_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_TEST}"
  FSIM_SYSTEMVERILOG_2023_VPI_OBJECT_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_MODEL}"
  FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_MODEL_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_TEST}"
  FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_HEADER}"
  FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_HEADER_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_SV_VPI_STANDARD_HEADER}"
  FSIM_SYSTEMVERILOG_2023_SV_VPI_STANDARD_HEADER_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_BRIDGE}"
  FSIM_SYSTEMVERILOG_2023_VPI_BRIDGE_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_PLUGIN_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_VPI_PLUGIN_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_TEST}"
  FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_C_PLUGIN}"
  FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_C_PLUGIN_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_CPP_PLUGIN}"
  FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_CPP_PLUGIN_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_RUNTIME_TEST_MAIN}"
  FSIM_SYSTEMVERILOG_2023_RUNTIME_TEST_MAIN_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_ABI_C_TEST}"
  FSIM_SYSTEMVERILOG_2023_VPI_ABI_C_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_VPI_ABI_CPP_TEST}"
  FSIM_SYSTEMVERILOG_2023_VPI_ABI_CPP_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DATA_READ_MODEL}"
  FSIM_SYSTEMVERILOG_2023_DATA_READ_MODEL_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DATA_READ_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_DATA_READ_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION}"
  FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DATA_READ_TEST}"
  FSIM_SYSTEMVERILOG_2023_DATA_READ_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION_TEST}"
  FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_MODEL}"
  FSIM_SYSTEMVERILOG_2023_ASSERTION_API_MODEL_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_ASSERTION_API_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION}"
  FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_PUBLICATION}"
  FSIM_SYSTEMVERILOG_2023_ASSERTION_API_PUBLICATION_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_TEST}"
  FSIM_SYSTEMVERILOG_2023_ASSERTION_API_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION_TEST}"
  FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION_TEST_CONTENTS)
...
file(READ "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_MODEL}"
  FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_MODEL_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_RUNTIME}"
  FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_RUNTIME_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_EXECUTION}"
  FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_EXECUTION_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_BOUNDARY}"
  FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_BOUNDARY_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_CACHE}"
  FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_CACHE_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_CACHE_TEST}"
  FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_CACHE_TEST_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_ARTIFACT}"
  FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_ARTIFACT_CONTENTS)
file(READ "${FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_ARTIFACT_TEST}"
  FSIM_SYSTEMVERILOG_2023_DISTRIBUTION_ARTIFACT_TEST_CONTENTS)
...
foreach(FSIM_SYSTEMVERILOG_2023_POLICY IN ITEMS
    ...
    "foreign-callback-scheduling"
    "artifact-cache-debug-trace"
    "cross-platform-foreign"
    "vpi-object-model"
    "standard-packages"
    ...
    "fsim-sv-sem-270"
    "fsim-elab-svpkg-011"
    "add_systemverilog_standard_package_identities"
    "test_standard_package_revision_rules"
    "kMaximumDistributionDraws = 1'000'000U"
    "0x007fffff"
    ...
    "SystemVerilog2017"
    "SystemVerilog2023"
    "legacy keyword selection must not restore syntax removed"
    "test_systemverilog_2023_annex_diagnostics"
    "FSIM_NATIVE_PLUGIN_ABI_VERSION 3u"
    "FSIM_NATIVE_PLUGIN_CAPABILITY_TF"
    "sv2023-foreign-composition.sv"
    "exact-2023 source retains DPI and registered legacy TF call sites"
    ...
    "systemverilog-2023-checkpoint"
    "debug.debugger_observation.find(interpreted.value)"
    "standard=systemverilog-2023"
  ...
  string(APPEND FSIM_SYSTEMVERILOG_2023_CONTENTS_LOWER
    "${FSIM_SYSTEMVERILOG_2023_ANNEX_CONTENTS_LOWER}")
  string(TOLOWER
    "${FSIM_NATIVE_PLUGIN_ABI_CONTENTS}${FSIM_TF_APPLICATION_IMPLEMENTATION_CONTENTS}${FSIM_SYSTEMVERILOG_2023_PLI_DPI_BRIDGE_CONTENTS}${FSIM_SYSTEMVERILOG_2023_PLI_DPI_RUNTIME_CONTENTS}${FSIM_SYSTEMVERILOG_2023_PLI_FRONTEND_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_PLI_TF_APPLICATION_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_PLI_TF_SCHEDULER_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_PLI_ACC_TF_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_PLI_ACC_VPI_TEST_CONTENTS}${FSIM_RUNTIME_TEST_CMAKE_CONTENTS}${FSIM_TEST_CMAKE_CONTENTS}"
    FSIM_SYSTEMVERILOG_2023_PLI_CONTENTS_LOWER)
  string(APPEND FSIM_SYSTEMVERILOG_2023_CONTENTS_LOWER
    "${FSIM_SYSTEMVERILOG_2023_PLI_CONTENTS_LOWER}")
  string(TOLOWER
    "${FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_C_PLUGIN_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_REFERENCE_CPP_PLUGIN_CONTENTS}${FSIM_SYSTEMVERILOG_2023_RUNTIME_TEST_MAIN_CONTENTS}${FSIM_RUNTIME_TEST_CMAKE_CONTENTS}"
    FSIM_SYSTEMVERILOG_2023_CROSS_PLATFORM_FOREIGN_CONTENTS_LOWER)
  string(APPEND FSIM_SYSTEMVERILOG_2023_CONTENTS_LOWER
    "${FSIM_SYSTEMVERILOG_2023_CROSS_PLATFORM_FOREIGN_CONTENTS_LOWER}")
  string(TOLOWER
    "${FSIM_SYSTEMVERILOG_2023_COVERAGE_RUNTIME_CONTENTS}${FSIM_SYSTEMVERILOG_2023_CODE_COVERAGE_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_FUNCTIONAL_COVERAGE_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_ASSERTION_COVERAGE_TEST_CONTENTS}"
    FSIM_SYSTEMVERILOG_2023_COVERAGE_CONTENTS_LOWER)
  string(APPEND FSIM_SYSTEMVERILOG_2023_CONTENTS_LOWER
    "${FSIM_SYSTEMVERILOG_2023_COVERAGE_CONTENTS_LOWER}")
  string(TOLOWER
    "${FSIM_SYSTEMVERILOG_2023_CALLBACK_MODEL_CONTENTS}${FSIM_SYSTEMVERILOG_2023_CALLBACK_RUNTIME_CONTENTS}${FSIM_SYSTEMVERILOG_2023_CALLBACK_TEST_CONTENTS}"
...
foreach(FSIM_SYSTEMVERILOG_2023_CROSS_PLATFORM_FOREIGN_POLICY IN ITEMS
    ...
    "vpi_reference_plugins"
    "fsim.runtime.vpi_reference_plugins"
    "c;cxx;plugin;linux;windows"
  ...
  string(TOLOWER
    "${FSIM_SYSTEMVERILOG_2023_CROSS_PLATFORM_FOREIGN_POLICY}"
    FSIM_SYSTEMVERILOG_2023_CROSS_PLATFORM_FOREIGN_POLICY_LOWER)
  string(FIND
    "${FSIM_SYSTEMVERILOG_2023_CROSS_PLATFORM_FOREIGN_CONTENTS_LOWER}"
    "${FSIM_SYSTEMVERILOG_2023_CROSS_PLATFORM_FOREIGN_POLICY_LOWER}"
    FSIM_INDEX)
  if(FSIM_INDEX EQUAL -1)
    message(FATAL_ERROR
      "SystemVerilog-2023 cross-platform foreign proof lost policy: ${FSIM_SYSTEMVERILOG_2023_CROSS_PLATFORM_FOREIGN_POLICY}")
  endif()
endforeach()

foreach(FSIM_SYSTEMVERILOG_2023_CALLBACK_POLICY IN ITEMS
    "SystemVerilogVpiCallbackError::ReentrantDispatch"
    "state->dispatching[index]"
    "SchedulerPhase::re_update"
    "DPI and VPI callbacks preserve every scheduler phase"
    "DPI context stack rejected callback entry"
    "dpi_max_reentry_depth == 64U")
  string(TOLOWER "${FSIM_SYSTEMVERILOG_2023_CALLBACK_POLICY}"
    FSIM_SYSTEMVERILOG_2023_CALLBACK_POLICY_LOWER)
  string(FIND "${FSIM_SYSTEMVERILOG_2023_CALLBACK_CONTENTS_LOWER}"
    "${FSIM_SYSTEMVERILOG_2023_CALLBACK_POLICY_LOWER}" FSIM_INDEX)
  if(FSIM_INDEX EQUAL -1)
    message(FATAL_ERROR
      "SystemVerilog-2023 callback proof lost policy: ${FSIM_SYSTEMVERILOG_2023_CALLBACK_POLICY}")
  endif()
endforeach()
...
foreach(FSIM_SYSTEMVERILOG_2023_COVERAGE_POLICY IN ITEMS
    ...
    "coverage.passes == 1"
    "coverage.failures == 0")
  string(TOLOWER "${FSIM_SYSTEMVERILOG_2023_COVERAGE_POLICY}"
    FSIM_SYSTEMVERILOG_2023_COVERAGE_POLICY_LOWER)
  string(FIND "${FSIM_SYSTEMVERILOG_2023_COVERAGE_CONTENTS_LOWER}"
    "${FSIM_SYSTEMVERILOG_2023_COVERAGE_POLICY_LOWER}" FSIM_INDEX)
  if(FSIM_INDEX EQUAL -1)
    message(FATAL_ERROR
      "SystemVerilog-2023 coverage proof lost policy: ${FSIM_SYSTEMVERILOG_2023_COVERAGE_POLICY}")
  endif()
endforeach()

string(TOLOWER
  "${FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_HEADER_CONTENTS}${FSIM_SYSTEMVERILOG_2023_SV_VPI_STANDARD_HEADER_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_BRIDGE_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_STANDARD_RUNTIME_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_PLUGIN_RUNTIME_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_ABI_C_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_ABI_CPP_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_TEST_CONTENTS}"
  FSIM_SYSTEMVERILOG_2023_VPI_HEADER_CONTENTS_LOWER)
foreach(FSIM_SYSTEMVERILOG_2023_VPI_HEADER_POLICY IN ITEMS
  ...
  string(TOLOWER "${FSIM_SYSTEMVERILOG_2023_VPI_HEADER_POLICY}"
    FSIM_SYSTEMVERILOG_2023_VPI_HEADER_POLICY_LOWER)
  string(FIND "${FSIM_SYSTEMVERILOG_2023_VPI_HEADER_CONTENTS_LOWER}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_HEADER_POLICY_LOWER}" FSIM_INDEX)
  if(FSIM_INDEX EQUAL -1)
    message(FATAL_ERROR
      "SystemVerilog-2023 VPI header bridge lost policy: ${FSIM_SYSTEMVERILOG_2023_VPI_HEADER_POLICY}")
  endif()
endforeach()

string(TOLOWER
  "${FSIM_SYSTEMVERILOG_2023_DATA_READ_MODEL_CONTENTS}${FSIM_SYSTEMVERILOG_2023_DATA_READ_RUNTIME_CONTENTS}${FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION_CONTENTS}${FSIM_SYSTEMVERILOG_2023_DATA_READ_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_DATA_READ_APPLICATION_TEST_CONTENTS}"
  FSIM_SYSTEMVERILOG_2023_DATA_READ_CONTENTS_LOWER)
foreach(FSIM_SYSTEMVERILOG_2023_DATA_READ_POLICY IN ITEMS
    ...
    "Time = 874"
    "maximum_loaded_objects"
    "maximum_value_changes"
    "Stage only histories selected by this request"
    "collection load rejects its complete over-limit transaction"
    "systemverilog_vpi_data_read")
  string(TOLOWER "${FSIM_SYSTEMVERILOG_2023_DATA_READ_POLICY}"
    FSIM_SYSTEMVERILOG_2023_DATA_READ_POLICY_LOWER)
  string(FIND "${FSIM_SYSTEMVERILOG_2023_DATA_READ_CONTENTS_LOWER}"
    "${FSIM_SYSTEMVERILOG_2023_DATA_READ_POLICY_LOWER}" FSIM_INDEX)
  if(FSIM_INDEX EQUAL -1)
    message(FATAL_ERROR
      "SystemVerilog-2023 data-read API lost policy: ${FSIM_SYSTEMVERILOG_2023_DATA_READ_POLICY}")
  endif()
endforeach()

string(TOLOWER
  "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_MODEL_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_RUNTIME_CONTENTS}${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_TEST_CONTENTS}${FSIM_DIAGNOSTICS_CONTENTS}"
  FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_CONTENTS_LOWER)
foreach(FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_POLICY IN ITEMS
    "std::array<Routine, 42> standard_routines"
    ...
    "FSIM-VPI-ROUTINE-001"
    "FSIM-VPI-ROUTINE-007")
  string(TOLOWER "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_POLICY}"
    FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_POLICY_LOWER)
  string(FIND "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_CONTENTS_LOWER}"
    "${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_POLICY_LOWER}" FSIM_INDEX)
  if(FSIM_INDEX EQUAL -1)
    message(FATAL_ERROR
      "SystemVerilog-2023 VPI routine bridge lost policy: ${FSIM_SYSTEMVERILOG_2023_VPI_ROUTINE_POLICY}")
  endif()
endforeach()

string(TOLOWER
  "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_MODEL_CONTENTS}${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_RUNTIME_CONTENTS}${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION_CONTENTS}${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_PUBLICATION_CONTENTS}${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_TEST_CONTENTS}${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_APPLICATION_TEST_CONTENTS}"
  FSIM_SYSTEMVERILOG_2023_ASSERTION_API_CONTENTS_LOWER)
foreach(FSIM_SYSTEMVERILOG_2023_ASSERTION_API_POLICY IN ITEMS
    "SystemVerilogVpiAssertionApi"
    "maximum_assertion_objects = 65'536"
    "maximum_assertion_text_bytes = 1U << 20U"
    "reserved_objects"
    "event.outcome != SystemVerilogVpiAssertionOutcome::Disabled"
    "saturating_increment"
    "control_hook"
    "enabled_vpi_assertion_processes"
    "set_fork_spawn_filter"
    "vpi_assertions->observe"
    "assertion_status.statistics.attempts == events.size()"
    "publishes no partial state when common control rejects a request")
  string(TOLOWER "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_POLICY}"
    FSIM_SYSTEMVERILOG_2023_ASSERTION_API_POLICY_LOWER)
  string(FIND "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_CONTENTS_LOWER}"
    "${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_POLICY_LOWER}" FSIM_INDEX)
  if(FSIM_INDEX EQUAL -1)
    message(FATAL_ERROR
      "SystemVerilog-2023 assertion API lost policy: ${FSIM_SYSTEMVERILOG_2023_ASSERTION_API_POLICY}")
  endif()
endforeach()
...
foreach(FSIM_SYSTEMVERILOG_VPI_COVERAGE_POLICY IN ITEMS
    ...
    "vpi-standard-coverage.fsimcov"
    "SystemVerilogVpiAssertionControlOperation::Enable"
...
string(REGEX MATCHALL
  "PRIVATE[ \t\r\n]+fsim_boost_pfr_headers"
  FSIM_TEST_BOOST_INCLUDE_BINDINGS
  "${FSIM_TEST_CMAKE_CONTENTS}")
...
list(LENGTH FSIM_TEST_BOOST_INCLUDE_BINDINGS FSIM_TEST_BOOST_INCLUDE_COUNT)
if(FSIM_BOOST_CONSUMER_INDEX EQUAL -1
    OR NOT FSIM_BOOST_INCLUDE_COUNT EQUAL 6
    OR NOT FSIM_FUZZ_BOOST_INCLUDE_COUNT EQUAL 1
    OR NOT FSIM_TEST_BOOST_INCLUDE_COUNT EQUAL 1)
  message(FATAL_ERROR
