...
if(FSIM_DEDUPLICATED_CTEST)
  message(STATUS
    "Verilog/SystemVerilog standard-mode fixture witnesses passed; nested CTest execution suppressed")
  return()
endif()
...
fsim_run_closure_matrix(
  "Verilog/SystemVerilog standard-mode closure" "${FSIM_STAGE_TIMEOUT_SECONDS}"
  ${FSIM_WITNESSES})
