    ...
    , container_registers_(storage_->container_registers)
{
    ...
    register_aval_.resize(layout.register_word_count);
    register_bval_.resize(layout.register_word_count);
    if (layout.uses_logic9) {
        register_logic9_plane2_.resize(layout.register_word_count);
        register_logic9_plane3_.resize(layout.register_word_count);
    }
