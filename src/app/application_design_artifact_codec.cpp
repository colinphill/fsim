...
#define FSIM_DESIGN_ARTIFACT_CODEC_CLASS
...
namespace codec_detail {
    ...
    void write_operation_group(Writer& writer, const runtime::simir::ContainerOperationGroup& group);
    void write_operation_group(Writer& writer, const runtime::simir::FileOperationGroup& group);
    void write_operation_group(Writer& writer, const runtime::simir::SchedulingOperationGroup& group);
...
bool read_operation(Reader& reader, runtime::simir::Operation& operation)
{
    ...
    case 3: return select_operation_group<runtime::simir::ContainerOperationGroup>(reader, operation);
    case 4: return select_operation_group<runtime::simir::FileOperationGroup>(reader, operation);
    case 5: return select_operation_group<runtime::simir::SchedulingOperationGroup>(reader, operation);
...
#if defined(FSIM_DESIGN_ARTIFACT_CODEC_CLASS)
