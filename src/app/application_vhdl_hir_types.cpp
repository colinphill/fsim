...
[[nodiscard]] semantic::DeclarationId VhdlHirBuilder::add_mode_view_declaration(
...
[[nodiscard]] semantic::DeclarationId VhdlHirBuilder::add_type_declaration(
    const frontend::TypeAliasDeclaration& input,
    const semantic::ScopeId scope,
    const semantic::OriginId parent)
{
...
void VhdlHirBuilder::add_type_payload(
    const frontend::TypeAliasDeclaration& input,
...
void VhdlHirBuilder::add_predefined_attributes(
...
void VhdlHirBuilder::add_array_payload(
    const frontend::Type& input,
    vh::TypeDefinition& output,
    const semantic::ScopeId scope,
    const semantic::OriginId parent)
...
void VhdlHirBuilder::add_record_payload(
    const frontend::Type& input,
    vh::TypeDefinition& output,
    const semantic::ScopeId scope,
    const semantic::OriginId parent)
...
void VhdlHirBuilder::add_indirect_type_payload(
    const frontend::Type& input,
    vh::TypeDefinition& output,
    const semantic::ScopeId scope,
    const semantic::OriginId parent)
...
void VhdlHirBuilder::add_protected_payload(
    const frontend::Type& input,
    vh::TypeDefinition& output,
