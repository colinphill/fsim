...
This is the Batch 130 Task 4 inspection record for all 16 `ML` mixed-language
...
The machine gate composes the final release audit, then parses all 44 rows
...
The strict gate covers all 44 rows and 14 distinct runtime evidence files. The
