...
precision rounding and automatic global-resolution choice. Parameterized or
otherwise nonconstant delay expressions and multiple rise/fall/turnoff delays
remain incomplete. This update supersedes the compact table's older
fractional-delay, delay-triplet, and declaration-based time limitations.
