...
strengths, switch primitives, specify timing, and SDF remain separate work.
...
DPI/VPI; program and clocking blocks; specify/timing checks; strengths and
switch primitives; and SDF.
