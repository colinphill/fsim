...
specialization and native-cache keys. Runtime mutable strings and methods,
arbitrary formatted argument lists, files, dynamic containers, and
cross-language string-parameter transfer remain unsupported.
