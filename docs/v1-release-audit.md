...
- 424 authored C/C++ sources remain within the 2,000-line limit;
...
| `B130-T7-INVENTORIES` | 7 | **Closed.** Diagnostics, source size, licenses, conformance, and provenance | The composed gate freezes 1,624 diagnostics, 424 bounded sources, 500 SPDX-owned artifacts, the 31-file/26-VHDL IEEE snapshot, 105 conformance expectations in 28 fixtures owned by 27 CTests, and 10 reviewed plus 6 excluded provenance identities |
