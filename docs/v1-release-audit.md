...
- 432 authored C/C++ sources remain within the 2,000-line limit;
...
| `B130-T7-INVENTORIES` | 7 | **Closed.** Diagnostics, source size, licenses, conformance, and provenance | The composed gate covers 1,631 diagnostics, 432 bounded sources, 516 SPDX-owned artifacts, the 31-file/26-VHDL IEEE snapshot, 105 conformance expectations in 28 fixtures owned by 27 CTests, and 10 reviewed plus 6 excluded provenance identities; v2 Batch 134 owns the current increase |
