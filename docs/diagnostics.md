...
| `FSIM-SV-SEM-042` | error | An output format string uses a conversion other than the supported `%b`/`%h`/`%o`/`%d`, more than one conversion, or a malformed percent escape. |
