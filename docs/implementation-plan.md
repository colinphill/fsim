...
### One-hundred-twenty-sixth feature batch — Typed HIR and DesignIR boundaries — Complete
...
### One-hundred-twenty-seventh feature batch — Language-wide legality closure — Complete
...
the official plan and resume handoff while Batch 128 is current. Tasks 1
through 9 used one accumulated dirty worktree with focused eight-worker Debug
builds and tests; Task 10 owns the single sanitizer, full-regression,
documentation, commit, and push gate. GitHub builds use parallelism four, and
Batch 127 does not require a non-documentation CI inspection.
...
### One-hundred-twenty-ninth feature batch — Linux and Windows language portability — Complete
...
Batch 129 record in both the plan and resume handoff. Tasks 1 through 9 used
...
and push gate. GitHub builds use parallelism four. Batch 129 was not a
...
### One-hundred-thirtieth feature batch — Final v1 release audit — Complete
...
### v1 release declaration — 2026-08-03

All conditions above are satisfied. The 1,080 required feature rows have
complete checked-in evidence and no explicit gap; the release-candidate,
legality, conformance, portability, inventory, resource, installed-public,
interpreter/O0/O2, cache, debugger, VCD, Tcl, SystemC, mixed-language,
sanitizer, and fuzz gates pass. GitHub Actions run
[`30839583995`](https://github.com/colinphill/fsim/actions/runs/30839583995)
passes all 12 Ubuntu and Windows GCC/MSVC/clang-cl Debug/Release configurations
with the exact LLVM 22.1.8 lanes. The bundled Tcl pin remains 9.0.4, which the
official Tcl [release chooser](https://www.tcl-lang.org/software/tcltk/choose.html)
and [download page](https://www.tcl-lang.org/software/tcltk/download.html)
identify as the current recommended production release at this final review.
