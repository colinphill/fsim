...
|---|---|---|---|
| `SRC-FSIM` | fsim `ee17e3999addf3c4c61b985a037be6afd5a2fa81`; [Apache-2.0](../LICENSE) | Existing language/runtime/API/debug/tool corpus and all 1,082 required matrix rows | Original baseline; every authored test/control file retains an Apache-2.0 SPDX notice |
