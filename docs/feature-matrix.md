...
| VH-020 | Constant packed indexed names/slices and width-summing `&` concatenation with descending, ascending, and non-zero-based signal/local ranges | execute | [frontend select/concatenation test](../tests/frontend/frontend_tests.cpp) | [reversed-slice diagnostic](../tests/elaboration/elaborator_test.cpp) | [typed range-aware lowering](../src/elaboration/elaborator.cpp) | [interpreter signal/local semantics](../tests/elaboration/elaborator_test.cpp), [interpreter/O2 application differential](../tests/app/application_test.cpp) |
...
| SV-029 | Constant bit/part selects and packed concatenations with declared descending, ascending, and non-zero-based signal/local range mapping | execute | [frontend select/concatenation test](../tests/frontend/frontend_tests.cpp) | [dynamic/reversed select and empty concatenation diagnostics](../tests/elaboration/elaborator_test.cpp) | [range-aware typed lowering](../src/elaboration/elaborator.cpp) | [interpreter signal/local range-direction test](../tests/elaboration/elaborator_test.cpp), [interpreter/O2 application differential](../tests/app/application_test.cpp) |
