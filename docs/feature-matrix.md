...
event-control/debug requirements: call instrumentation and addressable locals,
the full semantic fixture set, exhaustive assertion/trace fixtures, O0
application wait coverage, and Windows execution evidence remain open. The
