...
| SV-020 | Simple-expression dependency inference for `always @*` and time-zero `always_comb` | execute | [frontend wildcard/always_comb test](../tests/frontend/frontend_tests.cpp) | [language, explicit-control, timing, and NBA rejection](../tests/frontend/frontend_tests.cpp), [empty-dependency rejection](../tests/elaboration/elaborator_test.cpp) | [deterministic inferred-sensitivity test](../tests/elaboration/elaborator_test.cpp) | [interpreter propagation test](../tests/elaboration/elaborator_test.cpp), [three-process interpreter/O2 delta differential](../tests/app/application_test.cpp) |
...
| CM-029 | Deterministic read-dependency collection for wildcard combinational processes, with target exclusion and `always_comb` time-zero activation | execute | [frontend wildcard test](../tests/frontend/frontend_tests.cpp) | [empty dependency and illegal always_comb tests](../tests/frontend/frontend_tests.cpp), [elaboration rejection](../tests/elaboration/elaborator_test.cpp) | [ordered static-sensitivity test](../tests/elaboration/elaborator_test.cpp) | [tick-0/tick-1, delta-1/delta-2 interpreter/O2 differential](../tests/app/application_test.cpp) |
...
| V1-SV-06 | All `always` forms, functions/tasks, `final`, case/loops, and complete expression semantics | v1 target | [bounded `always`, `always_ff`, and `always_comb`](../tests/frontend/frontend_tests.cpp) | [bounded always_comb legality diagnostics](diagnostics.md) | [simple wildcard dependency inference](../tests/elaboration/elaborator_test.cpp) | [interpreter/O2 wildcard differential](../tests/app/application_test.cpp) |
