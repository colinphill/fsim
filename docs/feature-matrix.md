...
| CM-023 | REPL relative/absolute time runs, statement/process/delta/time stepping, source/time/signal breakpoints, scope/signal navigation, value mutation, and finished/poisoned lifecycle | execute | [application REPL test](../tests/app/application_test.cpp) | [poisoned-session checks](../tests/app/application_test.cpp) | — | [interpreter/O0 application REPL test](../tests/app/application_test.cpp) |
