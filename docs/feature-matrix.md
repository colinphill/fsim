...
| CM-015 | LLVM 22.1.8 ORC O0/O2 Logic4 CFGs through versioned plain-C runtime/frame/result ABIs and the checked allocation-free ≤64-bit `Logic4Word` path, including size-gated append-only v1 scheduled-write/debug controls, layout-preserving appended wait/debug statuses, suspension-safe loops, grouped specialization modules, and cache identity for scheduled writes, waits, and source points | execute | [LLVM resume, CFG, scheduled-write, signal-wait, debug-point, and grouped-module tests](../tests/compiler/llvm_jit_test.cpp), [scheduled word-path runtime test](../tests/runtime/runtime_tests.cpp), [C ABI layout/status/callback test](../tests/compiler/jit_runtime_c_test.c) | [wait-list/signal/width/edge, runtime-tail, malformed IR, ABI/layout, group/symbol, zero-time-cycle, and cache-corruption rejection](../tests/compiler/llvm_jit_test.cpp) | [LLVM process/group and scheduled/wait/source-point cache tests](../tests/compiler/llvm_jit_test.cpp) | [O0/O2 scheduled-write, signal-wait, debug-point, and grouped-module tests](../tests/compiler/llvm_jit_test.cpp), [exact application scheduled-write/overflow/posedge differentials](../tests/app/application_test.cpp), [exact-version CI job](../.github/workflows/ci.yml) |
...
| CM-020 | Full interactive debugger command set and statement/process/delta/time semantics | v1 target | [bounded source/conditional-signal breakpoints, all four step modes, live trace selection, and forced-O0 hybrid mode](../tests/app/application_test.cpp) | — | [O0 cache-mode identity](../tests/app/application_test.cpp) | [interpreter/O0 transcript, lifecycle, callback-count, and final-state equivalence plus debug-VCD selection](../tests/app/application_test.cpp) |
...
| V1-CM-06 | Full debugger REPL, safe points, stepping, breakpoints, scope/local inspection, trace selection, and Ctrl-C | v1 target | [bounded source/time/conditional-signal REPL with all four step modes, live trace selection, real SIGINT, and forced-O0 hybrid execution](../tests/app/application_test.cpp) | [poisoned lifecycle](../tests/app/application_test.cpp) | [source-point lowering and O0 cache-mode identity](../src/elaboration/elaborator.cpp) | [interpreter/O0 transcript, lifecycle, callback-count, final-state, SIGINT stop/resume/restore equivalence plus O0 debug-VCD selection](../tests/app/application_test.cpp) |
