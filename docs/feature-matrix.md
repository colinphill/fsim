...
| SV-019 | Any-change procedural `@(SIGNAL-LIST)` as a standalone or statement-controlling suspension | execute | [frontend event-control test](../tests/frontend/frontend_tests.cpp) | [edge-qualified event-control rejection](../tests/frontend/frontend_tests.cpp) | [dynamic-wait lowering test](../tests/elaboration/elaborator_test.cpp) | [interpreter wakeup test](../tests/elaboration/elaborator_test.cpp), [interpreter/O2 re-arming differential](../tests/app/application_test.cpp) |
...
| CM-024 | SimIR `WaitOn`/`WaitSensitivity` O0/O2 suspension using appended v1 statuses while immutable SimIR owns dynamic operands/static edge rules; source-level any-change waits lower through the same path and sensitivity-only signals may exceed 64 bits | execute | [O0/O2 signal-wait test](../tests/compiler/llvm_jit_test.cpp), [frontend wait tests](../tests/frontend/frontend_tests.cpp) | [empty-list, invalid-signal/width/edge, scalar-edge, and source-form rejection](../tests/compiler/llvm_jit_test.cpp) | [wait-kind/operand/referenced-width/static-edge cache invalidation](../tests/compiler/llvm_jit_test.cpp), [source wait lowering](../tests/elaboration/elaborator_test.cpp) | [interpreter/external-executor dynamic `WaitOn` differential with duplicate normalization and tick-1/tick-2 delta-1 wakeups](../tests/runtime/runtime_tests.cpp), [O0/O2 suspension-safe loop test](../tests/compiler/llvm_jit_test.cpp), [source-level SV dynamic-wait and VHDL periodic-wait application differentials](../tests/app/application_test.cpp) |
...
requirements: edge-qualified dynamic waits, named events, call
...
| V1-SV-07 | Delays/events, fork/join, named events, and complete NBA/delta behavior | v1 target | [bounded integer delays and any-change procedural event controls](../tests/frontend/frontend_tests.cpp) | [edge/wildcard procedural-control diagnostics](diagnostics.md) | [bounded timed/dynamic wait lowering](../tests/elaboration/elaborator_test.cpp) | [source-level interpreter/O2 wait differentials](../tests/app/application_test.cpp) |
