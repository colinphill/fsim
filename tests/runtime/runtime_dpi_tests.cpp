...
void test_systemverilog_dpi_scalar_marshalling() {
  ...
  require(
      unmarshal_systemverilog_dpi_scalar(
          wrong_plane, logic.width()).error == Error::PlaneSize
          && unmarshal_systemverilog_dpi_scalar(
                 dirty_high_bits, 8).error == Error::UnusedBits
          && unmarshal_systemverilog_dpi_scalar(
                 bit_payload.value, 7).error == Error::WidthMismatch,
      "DPI scalar output validates plane size, high bits, and exact width");
  require(
      marshal_systemverilog_dpi_scalar(
          PackedLogic4{}, Domain::Logic4).error == Error::EmptyWidth
          && marshal_systemverilog_dpi_scalar(
                 logic, Domain::Logic4, 64).error == Error::WidthLimit,
...
void test_systemverilog_dpi_real_string_chandle_marshalling() {
  ...
  require(
      negative_zero
          ...
          && unmarshal_systemverilog_dpi_real(
                 ...
                 .value.bits == negative_zero.value.bits,
  ...
  require(
      string_value && string_value.value.bytes == unicode
          && unmarshal_systemverilog_dpi_string(
                 string_value.value, Mode::Ref).value.bytes == unicode,
  ...
  require(
      marshal_systemverilog_dpi_string(
          embedded_nul, Mode::Input).error == Error::EmbeddedNul
          && marshal_systemverilog_dpi_string(
                 std::string{"\xC0\x80", 2}, Mode::Input).error
              == Error::InvalidUtf8
          && marshal_systemverilog_dpi_string(
                 "bounded", Mode::Input, 3).error == Error::StringLimit
          && unmarshal_systemverilog_dpi_string(
                 string_value.value, Mode::Input).error
  ...
  require(
      borrowed && borrowed.value.handle == handle && borrowed.value.borrowed
          ...
          && unmarshal_systemverilog_dpi_chandle(
                 registry, writable.value, Mode::Inout).value.handle == handle,
  ...
  require(
      marshal_systemverilog_dpi_chandle(
          registry, handle, Mode::Input).error == Error::StaleHandle
          && unmarshal_systemverilog_dpi_chandle(
                 registry, writable.value, Mode::Inout).error
              == Error::StaleHandle
          && unmarshal_systemverilog_dpi_chandle(
                 registry, borrowed.value, Mode::Input).error
              == Error::DirectionMismatch,
...
void test_systemverilog_dpi_composite_marshalling() {
  ...
  require(
      layout && layout.value.leaf_count == 4
          ...
          && unmarshal_systemverilog_dpi_composite(
                 payload.value, records, Mode::Ref).value == leaves,
  ...
  require(
      marshal_systemverilog_dpi_composite(
          records, invalid_enum, Mode::Input).error == Error::EnumValue
          && layout_systemverilog_dpi_composite(oversized).error
              == Error::ElementCount
          && unmarshal_systemverilog_dpi_composite(
                 payload.value, mismatched, Mode::Ref).error
              == Error::InvalidDescriptor
          && unmarshal_systemverilog_dpi_composite(
                 payload.value, records, Mode::Input).error
              == Error::DirectionMismatch,
...
void test_systemverilog_dpi_open_arrays() {
  ...
  require(
      registry.element(handle.value, {3, -1}).value.front()
              .to_msb_string() == "00000000"
          && registry.element(handle.value, {2, 1}).value.front()
                 .to_msb_string() == "00000101"
  ...
  auto writable_pointer =
      registry.mutable_element_pointer(handle.value, {2, 0});
  require(
  ...
  *writable_pointer.value = PackedLogic4::from_msb_string("10101010");
  ...
  require(
      registry.store_element(
          handle.value, {3, 0},
          {PackedLogic4::from_msb_string("11111111")}) == Error::None
          && registry.element(handle.value, {3, 0}).value.front()
                 .to_msb_string() == "11111111"
...
void test_systemverilog_dpi_callbacks() {
  ...
  require(
      callbacks.register_callback(
          ...
          && callbacks.dispatch(
                 "bad_write", {{PackedLogic4(1, Logic4::zero)}}, context).error
              == Error::DirectionMismatch,
  ...
  require(
      callbacks.register_callback(
          ...
          [](SystemVerilogDpiCallbackFrame&) {}) == Error::None
  ...
  require(
      callbacks.register_callback(
          ...
          [](SystemVerilogDpiCallbackFrame& frame) {
            ...
            if (output) output->front() = PackedLogic4(1, Logic4::one);
  ...
  require(
      tasks.register_task(
          ...
          [&](SystemVerilogDpiCallbackFrame& frame, const std::size_t resume) {
            ...
            auto* output = frame.writable(1);
            if (output) output->front() = PackedLogic4::from_msb_string("1111");
            return SystemVerilogDpiTaskAction{};
          }) == Error::None,
...
void test_systemverilog_dpi_plugin_planning() {
  ...
  require(
      plan_systemverilog_dpi_plugin(
          invalid, "/project", "/build", {}, "c++", Platform::Posix).error
              == Error::InvalidSource,
  ...
  loaded.value.reset();
  require(
      add_symbol && c_symbol && systemverilog_dpi_plugin_artifact_loaded(
          FSIM_DPI_TEST_PLUGIN_PATH) && add(7, 5) == 12
          && c_mix(7, 5) == 26,
  ...
  require(
      validate_systemverilog_dpi_plugin_descriptor(
          valid_descriptor, manifest) == Error::None
          && validate_systemverilog_dpi_plugin_descriptor(
                 invalid_descriptor, manifest) == Error::AbiVersion,
  ...
  require(
      validate_systemverilog_dpi_plugin_descriptor(
          invalid_descriptor, manifest) == Error::AbiPointerWidth,
