...
SystemVerilogVpiTypeInfo descriptor_type(
  ...
  type.descriptor =
      std::make_shared<const SystemVerilogVpiTypeDescriptor>(descriptor);
...
void test_systemverilog_vpi_recursive_type_descriptors() {
  ...
  const auto packed_layout =
      validate_systemverilog_vpi_descriptor(packed);
  ...
  const auto record_layout =
      validate_systemverilog_vpi_descriptor(record);
  require_vpi_descriptor(
  ...
  memory.ranges = {{3, 0}};
  const auto dynamic_memory_layout =
      validate_systemverilog_vpi_descriptor(memory);
  require_vpi_descriptor(
  ...
  const auto class_layout =
      validate_systemverilog_vpi_descriptor(class_descriptor);
  require_vpi_descriptor(
  ...
  require_vpi_descriptor(
      root && memory_object && queue_object && string_object
  ...
  auto mutable_descriptor =
      std::make_shared<SystemVerilogVpiTypeDescriptor>(enum_descriptor());
