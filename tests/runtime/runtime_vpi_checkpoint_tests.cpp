...
struct CheckpointFixture {
  ...
  explicit CheckpointFixture(const std::uint64_t identity)
    ...
    const auto created_value =
        objects.create(SystemVerilogVpiObjectDescriptor{
    ...
    require_vpi_checkpoint(
        objects.bind_value(value, checkpoint_value(4, Logic4::zero))
...
void test_systemverilog_vpi_checkpoint_restart_and_artifact() {
  ...
  const auto saved_value = checkpoint_value(4, Logic4::one);
  const auto saved_force = checkpoint_value(4, Logic4::x);
  require_vpi_checkpoint(
  ...
  const auto descriptor =
      source.io.open_file_descriptor("retained.log", "w");
  require_vpi_checkpoint(
  ...
  require_vpi_checkpoint(
      source.objects.release_forced_value(source.value)
          ...
          && source.objects.deposit_value(
                 source.value, checkpoint_value(4, Logic4::zero))
              == SystemVerilogVpiValueError::None,
  ...
  require_vpi_checkpoint(
      source.systems.execute("$checkpoint_task", source.top)
              .error == SystemVerilogVpiSystemError::None
  ...
  require_vpi_checkpoint(
      restore_systemverilog_vpi_checkpoint(
          ...
          target.io,
          compatibility)
              .error == SystemVerilogVpiCheckpointError::SchemaMismatch,
  ...
  require_vpi_checkpoint(
      restore_systemverilog_vpi_checkpoint(
          ...
          target.io,
          compatibility)
              .error == SystemVerilogVpiCheckpointError::HostAbiMismatch,
  ...
  require_vpi_checkpoint(
      restore_systemverilog_vpi_checkpoint(
          ...
          target.io,
          compatibility)
              .error == SystemVerilogVpiCheckpointError::PluginAbiMismatch,
  ...
  require_vpi_checkpoint(
      restore_systemverilog_vpi_checkpoint(
          ...
          target.io,
          expected)
              .error == SystemVerilogVpiCheckpointError::ContentMismatch,
  ...
  require_vpi_checkpoint(
      restore_systemverilog_vpi_checkpoint(
          ...
          target.io,
          expected)
              .error == SystemVerilogVpiCheckpointError::CacheMismatch,
  ...
  require_vpi_checkpoint(
      restore_systemverilog_vpi_checkpoint(
          ...
          target.io,
          expected)
              .error == SystemVerilogVpiCheckpointError::PluginMismatch,
  ...
  require_vpi_checkpoint(
      restore_systemverilog_vpi_checkpoint(
          ...
          target.io,
          compatibility)
              .error == SystemVerilogVpiCheckpointError::ObjectStateMismatch,
  ...
  const auto restored = restore_systemverilog_vpi_checkpoint(
      ...
      compatibility);
  require_vpi_checkpoint(
      restored && restored.handles.size()
              == captured.artifact.objects.objects.size()
