...
| [feature_matrix/vhdl_2019_inventory.tsv](vhdl_2019_inventory.tsv) | Independently worded 37-row IEEE 1076-2019 delta inventory assigning every frontend and runtime obligation one-to-one to Batch 183 Changes 2-19 and Batch 184 Changes 1-19; Change 1 begins with all rows active and records only standard identifiers, clause numbers, project-authored summaries, and repository ownership |
