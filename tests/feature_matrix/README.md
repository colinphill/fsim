...
| [app/application_test_classes.cpp](../app/application_test_classes.cpp) | Class specialization, base-handle construction, hidden base/derived properties, shared static initialization, scheduled explicit-base/virtual dispatch, time/delta callbacks, debugger reads, interpreter/LLVM O2/debug-O0 agreement, and source-hidden standalone/relocated mapped-artifact execution |
