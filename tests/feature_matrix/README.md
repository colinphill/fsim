...
| [systemc/plugin_loader_test.cpp](../systemc/plugin_loader_test.cpp) | Native plug-in load/transactional factory registration, typed module/port/foreign-child construction with opaque-handle connectivity, and throwing-initializer containment without partial registration |
