...
| [app/vhdl_array_application_test.cpp](../app/vhdl_array_application_test.cpp) | Nominal VHDL arrays plus ascending/descending dynamic slice reads, debug-visible local and projected single/multi signal targets, exact Logic9 values, hierarchy/debugger inspection, normalized VCD, interpreter/LLVM O0/O2 cold-warm parity, package-edit invalidation, and identical runtime-bound failures |
