...
| [feature_matrix/systemverilog_2023_inventory.tsv](systemverilog_2023_inventory.tsv) | Independently worded 56-row IEEE 1800-2023 delta inventory assigning frontend, verification, hierarchy, timing, foreign API, and closure obligations one-to-one to Batch 185 Changes 2-19 and Batch 186-187 Changes 1-19; the profile-identity, lexical/preprocessing, and design-unit scheduling rows are preserved after Batch 185 Change 4, 53 rows remain active, and the ledger records only standard identifiers, clause numbers, project-authored summaries, and repository ownership |
