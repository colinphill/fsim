...
| [library/library_artifact_test.cpp](../library/library_artifact_test.cpp) | CM-087 canonical `.fsimlib` metadata, checksum validation, deterministic publication, read-only installation, schema-17 portable VHDL/SystemVerilog unit and embedded-PSL round trips, relocation, and malformed/schema/path/depth/identity rejection |
