...
| [app/resolution_application_test.cpp](../app/resolution_application_test.cpp) | Source-ID-marked mixed VHDL/SystemVerilog driver ownership and standard-logic resolution plus zero/inertial/transport/reject/transition/region/postponed timing across both boundary directions, exact driver histories and callbacks, interpreter/LLVM O0/O2 parity, VCD, cache reuse, and edit invalidation |
...
| [app/vhdl_ieee_integration_application_test.cpp](../app/vhdl_ieee_integration_application_test.cpp) | Reusable-context activation of every reviewed package, exact compiler-supplied declaration/body order, fully qualified intrinsic exports, simultaneous two-/nine-state numeric identity, mixed overload dispatch, package-source specialization closure, typed debugger locals, exact VCD, O0/O2 parity, cold/warm reuse, and context-edit invalidation |
