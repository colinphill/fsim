...
module strength_systemc_wrapper;
  ...
  assert(generated.ok());
  const auto generated_value =
      generated.design->find_signal("generated_strength.enabled.value");
  ...
  const auto disconnected_b =
      topology.design->find_signal("topology_corner.disconnected_b");
