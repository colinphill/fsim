...
Capture run_once(
  ...
  std::optional<std::pair<
      fsim::runtime::simir::ProcessId, std::size_t>> access_local;
  std::optional<std::pair<
      fsim::runtime::simir::ProcessId, std::size_t>> physical_local;
  ...
  capture.physical_local = simulation.read_process_local(
      physical_local->first, physical_local->second).to_msb_string();
  {
