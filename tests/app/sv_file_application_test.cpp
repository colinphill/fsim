    ...
    const auto write_source =
        [&](const std::string_view label) {
            ...
            output
                ...
                << "  integer raw_handle;\n"
                << "  integer raw_two_count;\n"
                << "  integer raw_four_count;\n"
                << "  integer scan_hex;\n"
                ...
                << "  logic [36:0] raw_two_write;\n"
                << "  logic [36:0] raw_two_read;\n"
                << "  logic [36:0] raw_four_write;\n"
                << "  logic [36:0] raw_four_read;\n"
                ...
                << "    raw_two_write = 37'h123456789;\n"
                << "    raw_four_write = 37'h1x345678z;\n"
                << "    raw_handle = $fopen(\"raw-two.bin\", \"wb\");\n"
                << "    $fwrite(raw_handle, \"%u\", raw_two_write);\n"
                << "    $fclose(raw_handle);\n"
                << "    raw_handle = $fopen(\"raw-two.bin\", \"rb\");\n"
                << "    raw_two_count = $fscanf(raw_handle, \"%u\", raw_two_read);\n"
                << "    $fclose(raw_handle);\n"
                << "    raw_handle = $fopen(\"raw-four.bin\", \"wb\");\n"
                << "    $fwrite(raw_handle, \"%z\", raw_four_write);\n"
                << "    $fclose(raw_handle);\n"
                << "    raw_handle = $fopen(\"raw-four.bin\", \"rb\");\n"
                << "    raw_four_count = $fscanf(raw_handle, \"%z\", raw_four_read);\n"
                << "    $fclose(raw_handle);\n"
                ...
                << "    $fdisplay(writer, \"raw=%0d/%0h/%0d/%0h\", raw_two_count, raw_two_read, raw_four_count, raw_four_read);\n"
