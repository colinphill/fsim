...
module container_top;
  ...
  initial begin
    ...
    source_copy = '{1, 2};
    independent_copy = source_copy;
    source_copy[0] = 9;
    assert (independent_copy.size() == 2);
    assert (independent_copy[0] == 1);
    independent_copy.delete();
    assert (independent_copy.size() == 0);
    assert (source_copy.size() == 2);
    assert (source_copy[0] == 9);
    fresh = new[2];
