...
/* Stable compatibility spellings retained by fsim's v3 SDK. */
#define vpiCoverageStop vpiCoverageStOp
#define vpiCoveredMax vpiCoverMax

/* Standardized design-data reader identities. */
#define vpiTrvsObj 800
#define vpiCollection 810
#define vpiObjCollection 811
#define vpiTrvsCollection 812

#define vpiIsLoaded 820
#define vpiHasDataVC 821
#define vpiHasVC 822
#define vpiHasNoValue 823
#define vpiBelong 824

#define vpiAccessLimitedInteractive 830
#define vpiAccessInteractive 831
#define vpiAccessPostProcess 832
#define vpiDataLoaded 850

#define vpiMinTime 860
#define vpiMaxTime 864
